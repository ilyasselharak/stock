export const fr = {
  ...
  notCounted: 'Non comptés',
  notCountedOne: 'À compter',
  counted: 'Comptés',
  differences: 'Écarts',
  countedQty: 'Compté',
  difference: 'Écart',
  matched: 'Conformes',
  surplus: 'Excédents (compté > stock)',
  shortage: 'Manquants (compté < stock)',
  extraItems: 'Articles hors système',
  extraItemsHint: 'Articles trouvés en rayon mais absents de la liste des produits',
  analysis: "Analyse de l'inventaire",
  finishCount: 'Terminer et analyser',
  resetCount: 'Réinitialiser',
  resetCountConfirm: 'Effacer tout le comptage en cours et recommencer à zéro ?',
  scanHint: 'Rechercher, ou scanner un SKU + Entrée pour compter 1',
  clearCount: 'Annuler le comptage',
  allCounted: 'Tous les produits ont été comptés',
  none: 'Aucun',
...
export const ar = {
  ...
  page: 'الصفحة',
  exportPdf: 'تصدير PDF',
  dailyActivity: 'سجل اليوم',
  close: 'إغلاق',
  saleUpdated: 'تم تحديث البيع بنجاح',
  saleNotFound: 'البيع غير موجود',
  inventory: 'الجرد',
  productsCounted: 'منتجات تم عدها',
  startedAt: 'بدأ في',
  notCounted: 'غير معدودة',
  notCountedOne: 'لم يُعد',
  counted: 'معدودة',
  differences: 'الفروقات',
  countedQty: 'المعدود',
  difference: 'الفرق',
  matched: 'مطابقة',
  surplus: 'فائض (المعدود > المخزون)',
  shortage: 'نقص (المعدود < المخزون)',
  extraItems: 'منتجات غير مسجلة',
  extraItemsHint: 'منتجات موجودة فعلياً لكنها غير موجودة في قائمة المنتجات',
  analysis: 'تحليل الجرد',
  finishCount: 'إنهاء وتحليل',
  resetCount: 'إعادة التعيين',
  resetCountConfirm: 'مسح كل العد الحالي والبدء من الصفر؟',
  scanHint: 'ابحث، أو امسح SKU ثم Enter لعد 1',
  clearCount: 'إلغاء العد',
  allCounted: 'تم عد جميع المنتجات',
  none: 'لا شيء',
